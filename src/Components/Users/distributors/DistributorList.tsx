...
//         if (userRole === "Admin") {
//           apiUrl = "http://localhost:8080/api/auth/adminmds";
//         } else {
//           apiUrl = "http://localhost:8080/api/auth/users";
//         }
...
export default function DistributorList() {
  ...
  //       if (userRole === "Admin") {
  //         apiUrl = "http://localhost:5000/api/auth/adminds";
  //       } else {
  ...
  //     };
  //     await axios.delete(
  //       `http://localhost:5000/api/deleteDistributor/${itemId}`,
  //       {
  //         headers: headers,
  //       }
  //     );
  ...
  //     };
  //     await axios.put(
  //       `http://localhost:5000/api/update/distributor/${itemId}`,
  //       {
  //         headers: headers,
  //       }
  //     );
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          ...
          "http://localhost:5000/api/protected/underme/Distributor",
          {
            headers: headers,
          }
        );
  ...
  return (
    <section className="main container w-full flex flex-col !gap-6 my-8 h-[calc(100vh-9rem)]">
      ...
      <div className="">
        <p className="text-black font-bold">Registered Distributor</p>
      </div>

      <div className="w-full flex flex-col items-start justify-start mt-8">
        <TableContainer component={Paper}>
          <Table aria-label="Registered Distributor">
            <TableHead>
              <TableRow>

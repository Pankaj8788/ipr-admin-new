...
export default function MasterDistributorList() {
  ...
  //         Authorization: token,
  //       };
  //       // master distributer route link
  //       const response = await axios.get(
  //         "http://localhost:8080/api/auth/adminmds",
  //         {
  //           headers: headers,
  //         }
  //       );
  ...
  //     };
  //     await axios.put(
  //       `http://localhost:8080/api/update/masterdistributor/${itemId}`,
  //       {
  //         headers: headers,
  //       }
  //     );
  ...
  //       // if (userRole === "Admin") {
  //       //   apiUrl = "http://localhost:5000/api/auth/adminmds";
  //       // } else {
  //       //   apiUrl = "http://localhost:5000/api/auth/users";
  //       // }

  //       const response = await axios.get(
  //         "http://localhost:5000/api/protected/underme/Master_Distributor",
  //         {
  //           headers: headers,
  //         }
  //       );
  ...
  //     };
  //     await axios.delete(
  //       `http://localhost:5000/api/deleteMasterDistributor/${itemId}`,
  //       {
  //         headers: headers,
  //       }
  //     );
  ...
  //     };
  //     await axios.put(
  //       `http://localhost:5000/api/update/MasterDistributor/${itemId}`,
  //       {
  //         headers: headers,
  //       }
  //     );
  ...
  return (
    <section className="main container w-full flex flex-col !gap-6 my-8 h-[calc(100vh-9rem)]">
      ...
      <div className="">
        <p className="text-black font-bold">Registered Master Distributor</p>
      </div>

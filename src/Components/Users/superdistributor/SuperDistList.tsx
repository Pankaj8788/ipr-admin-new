...
export default function SuperDistList() {
  ...
  //         "http://localhost:8080/api/auth/adminsds",
  //         {
  //           headers: headers,
  //         }
  //       );
  ...
  //       if (userRole === "Admin") {
  //         apiUrl = "http://localhost:5000/api/auth/adminsds";
  //       } else {
  ...
  //     };
  //     await axios.delete(
  //       `http://localhost:5000/api/deleteSuperDistributor/${itemId}`,
  //       {
  //         headers: headers,
  //       }
  //     );
  ...
  //     };
  //     await axios.put(
  //       `http://localhost:5000/api/update/superdistributor/${itemId}`,
  //       {
  //         headers: headers,
  //       }
  //     );
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          ...
          "http://localhost:5000/api/protected/underme/Super_Distributor",
          {
            headers: headers,
          }
        );
  ...
  return (
    ...
    //   <div className="">
    //     <p className="text-black font-bold">Registered Super Distributor</p>
    //   </div>

    //   <div className="w-full flex flex-col items-start justify-start mt-8">
    //     <TableContainer component={Paper}>
    //       <Table aria-label="Registered Retailer">
    //         <TableHead>
    //           <TableRow>
    ...
    //             {/* <TableCell>Main Balance</TableCell> */}
